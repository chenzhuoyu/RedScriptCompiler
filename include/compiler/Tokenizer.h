...
public:
    void asEof(void) const
    {
        if (_type != Type::Eof)
        {
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format(
                "\"Eof\" expected, but got \"%s\"",
                toString()
            ));
        }
    }
...
public:
    std::string asString(void)
    {
        if (_type == Type::String)
            ...
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format("\"String\" expected, but got \"%s\"", toString()));
    }
...
public:
    Utils::Decimal asDecimal(void) const
    {
        if (_type == Type::Decimal)
            ...
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format("\"Decimal\" expected, but got \"%s\"", toString()));
    }
...
public:
    Utils::Integer asInteger(void) const
    {
        if (_type == Type::Integer)
            ...
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format("\"Integer\" expected, but got \"%s\"", toString()));
    }
...
public:
    Keyword asKeyword (void) const
    {
        if (_type == Type::Keywords)
            ...
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format("\"Keyword\" expected, but got \"%s\"", toString()));
    }
...
public:
    Operator asOperator(void) const
    {
        if (_type == Type::Operators)
            ...
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format("\"Operator\" expected, but got \"%s\"", toString()));
    }
...
public:
    std::string asIdentifier(void)
    {
        if (_type == Type::Identifiers)
            ...
            throw Runtime::Exceptions::SyntaxError(this, Utils::Strings::format("\"Identifier\" expected, but got \"%s\"", toString()));
    }
